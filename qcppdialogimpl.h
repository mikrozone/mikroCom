...
class QCPPDialogImpl:public QWidget, public Ui::mikroComDlg
{
   Q_OBJECT
   public:
...
private slots:
      ...
      void on_m_DTR_clicked(bool checked);
      void on_m_RTS_clicked(bool checked);
};
